            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('enrollments.update', $enrollment) }}">
                        ...
                        <div class="mt-6">
                            ...
                            <input type="number" name="score" class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm @error('score') border-red-500 @enderror" 
                                   value="{{ old('score', $enrollment->score) }}" min="0" max="100" required>
                        ...
                        <div class="flex gap-4 mt-6">
                            ...
                            <a href="{{ route('students.show', $enrollment->student_id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Cancel
                            </a>
                        </div>
                    </form>
                    ...
                    <div class="mt-8 bg-gray-50 rounded-lg p-6">
                        <h5 class="text-lg font-medium text-gray-900 mb-4">Current Enrollment Details</h5>
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <span class="font-medium text-gray-700">Student:</span>
                                <span class="text-gray-900">{{ $enrollment->student->name }}</span>
                            </div>
                            <div>
                                <span class="font-medium text-gray-700">Course:</span>
                                <span class="text-gray-900">{{ $enrollment->course->name }}</span>
                            </div>
                            <div>
                                <span class="font-medium text-gray-700">Current Score:</span>
                                <span class="text-gray-900">{{ $enrollment->score }}</span>
                            </div>
                            <div>
                    ...
                    <div class="mt-8 bg-blue-50 rounded-lg p-6">
                        <h5 class="text-lg font-medium text-blue-900 mb-4">Grade Scale</h5>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-blue-800">= 4.0 points</span>
                            </div>
                            <div class="flex items-center space-x-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-blue-800">= 3.0 points</span>
                            </div>
                            <div class="flex items-center space-x-2">
